    ...
    public static void main(String [] args){
        ...
        while(playAgain.equalsIgnoreCase("y")){
            ...
            /* 
                   ...
                   NEW CODE FOR VERSION TWO BELOW - THIS IS THE SECTION FOR IF THE USER WOULD LIKE FEEDBACK IMMEDIATELY
                   ASKS THE USER AT THIS POINT
            ...
            feedback = userInput.next(); //allows the user to enter their answer - this is then stored in feedback. The user can enter a decision becasue this is an instance of the scanner 
                ...
                do{ //asks the user 10 questions - go through this loop
                   ...
                   NEW CODE FOR VERSION TWO BELOW - THIS IS THE SECTION FOR IF THE USER WOULD LIKE FEEDBACK IMMEDIATELY
                   OUTPUTS THE FEEDBACK OR DOESN'T DEPENDING ON USER CHOICE
                   
                   
                   */
                    
                    else if (feedback.equalsIgnoreCase("y")){//if they dont get the right answer, print sorry message and correct answer
                        //this only happens if the user has asked for it - ie. when feedback is set to Y or y (can be either due to ignoreCase
                ...
                /* 
                   ...
                   NEW CODE FOR VERSION TWO BELOW - THIS IS THE SECTION FOR DIFFERENT OUTPUT DEPENDENT ON SCORE
